...
public class Main3Activity extends AppCompatActivity {
    ...
    public void submitAnswer(View view) {
        ...
        Toast.makeText(Main3Activity.this, "You answered " + count + " of the 3 questions correct.", Toast.LENGTH_SHORT).show();
        count = 0;
    }
    ...
    public void questionThird(String word) {
        ...
        if (word.toLowerCase().contains("Rajendra Prasad".toLowerCase())) {
