...
public class Main2Activity extends AppCompatActivity {
    ...
    public void submitAnswer(View view) {
        ...
        Toast.makeText(Main2Activity.this, "You answered " + count + " of the 3 questions correct.", Toast.LENGTH_SHORT).show();
        count = 0;
    }
    ...
    public void questionTwo(boolean one, boolean two, boolean three, boolean four) {
        ...
        if (one == false && two == false && three == true && four == true) {
            text.setText("\u2713Correct");
            text.setTextColor(Color.GREEN);
            count++;
        } else {
    ...
    public void questionThird(String word) {
        ...
        if (word.toLowerCase().contains("Momentum".toLowerCase())) {
